...
int main() {
	string vertexShaderSource = shaderLibrary::loadShaderSourceFromFile("assets/vertexShader.vert");
	string fragmentShaderSource = shaderLibrary::loadShaderSourceFromFile("assets/fragmentShader.frag");
